...
@Entity(tableName = "notas_4a")
public class Nota_4a { // 4a Classe
    ...
    public void setCn_nf(int cn_nf) {
        this.cn_nf = cn_nf;
    }
    ...
    public void setCs_nf(int cs_nf) {
        this.cs_nf = cs_nf;
    }
}
